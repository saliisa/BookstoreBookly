...
(9, '9780141439662', 'Sense and Sensibility', 'Jane Austen', '1811-04-29', 7.5, 'Fiction', 'Romance', 'Marianne Dashwood wears her heart on her sleeve, and when she falls in love with the dashing but unsuitable John Willoughby she ignores her sister Elinor&#39;s warning that her impulsive behaviour leaves her open to gossip and innuendo. Meanwhile Elinor, always sensitive to social convention, is struggling to conceal her own romantic disappointment, even from those closest to her. Through their parallel experience of love - and its threatened loss - the sisters learn that sense must mix with sensibility if they are to find personal happiness in a society where status and money govern the rules of love.', 'https://cdn.penguin.co.uk/dam-assets/books/9780141439662/9780141439662-jacket-large.jpg'),
(10, '9780241962138', 'The Course of Love', 'Alain de Botton', '2017-01-26', 12.5, 'Non-Fiction', 'Self-Help', 'Modern love is never easy. Society is obsessed with stories of romance, but what comes after happily ever after?\r\n\r\nThis is a love story with a difference. From dating to marriage, from having kids to having affairs, it follows the progress of a single ordinary relationship: tender, messy, hilarious, painful, and entirely un-Romantic. It is a love story for the modern world, chronicling the daily intimacies, the blazing rows, the endless tiny gestures that make up a life shared between two people. Moving and deeply insightful, The Course of Love offers us a window into essential truths about the nature of love.', 'https://i.pinimg.com/564x/a9/31/ed/a931ed7ec56e8f462130b7f687a6ecf7.jpg');
...
('18098602145', 'Jane', 'Doe', 'jane.doe@email.com', '$2y$10$I5qZDTIxy2TryqYOvRVBXewO759bmE5Z8KKyK1UgDSpBHkVe9zMD2', 'Street Address 1234', 'Helsinki', 'Finland', '00100'),
('78860365834', 'John', 'Doe', 'john.doe@email.com', '$2y$10$KC9Y.2Cimo33gsj3VsW5bO77y2ZqLy64KaPFtD.nz8nWxYFABDrFu', 'Street Address 1122', 'Helsinki', 'Finland', '00200');
...
INSERT INTO `orders_detail` (`Detail_id`, `order_id`, `book_id`, `amount`, `total_cost`) VALUES
(1, 1, 8, 1, 20.5),
(2, 1, 7, 1, 16.5),
(3, 2, 3, 1, 12.5),
(4, 3, 6, 1, 15.5),
...
INSERT INTO `orders_table` (`Order_id`, `order_date`, `delivery_date`, `customer_id`) VALUES
(1, '2024-04-08', '2024-04-11', '18098602145'),
(2, '2024-04-08', '2024-04-11', '18098602145'),
(3, '2024-04-08', '2024-04-11', '78860365834');
